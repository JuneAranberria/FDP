...
states = {'Sleeping', 'Anes', 'AnesProp', 'AwakeC', 'AwakeD'};
totals = [851, 116, 106, 197, 192]; % Ajusta los valores de 'total' para cada estado
...
for k = 1:length(states)
    ...
    comb_3syn = {data_analysis(idx_3syn).combinacion};
    comb_3red = {data_analysis_3red(idx_3red).combinacion};
    comb_4red = {data_analysis_4red(idx_4red).combinacion};
